                                ...
                                <div class="cv-download">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <p class="topnote">Fill all required fields and click create cv to download
                                                CV in both PDF and PNG formats</p>
                                                ...
                                                <div class="mt-30">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <input type="text" name="jop-title" class="form-control"
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <textarea name="comments" id="comments" rows="4"
                                                                class="form-control" placeholder="About Me :"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
