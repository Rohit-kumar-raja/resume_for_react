        ...
        @slot('body')
                ...
                <div class="breadcumb-area clearfix dzsparallaxer auto-init mode-scroll animation-engine-js dzsprx-readyall"
                    ...
                    <div class="divimage dzsparallaxer--target"
                        style="width: 101%; height: 130%; background-image: url(&quot;img/bg-img/bg-2.jpg&quot;); transform: translate3d(0px, -46.4932px, 0px);">
                    </div>
                    <!-- breadcumb content -->
                                ...
                                <div class="col-12">
                                    <nav aria-label="breadcrumb" class="breadcumb--con text-center">
                                        <h2 class="w-text title wow fadeInUp" data-wow-delay="0.2s"
                                            style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">About
                                            us</h2>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                ...
                                <div class="services-block-four">
                                    <div class="inner-box">
                                        ...
                                        <div class="text">Lorem ipsum dolor sit amet, consectetur adipisicing elit
                                            skaj gjska consectetur adipisicing elit.</div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="who-we-contant mt-s">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore eius molestiae facere,
                                        natus reprehenderit eaque eum, autem ipsam. Magni, error. Tempora odit laborum iure
